...
public class OreSpawnMain {
  ...
  public void preInit(FMLPreInitializationEvent event) {
    ...
    CrystalFurnaceBlock = (CrystalFurnace)(new CrystalFurnace(BaseBlockID + 212, false, 2.0F, 10.0F)).setBlockName("crystalfurnace");
    ...
    MyStrawberryPlant = (Block)new BlockStrawberry(BaseBlockID + 153);
    ...
    MyRicePlant = (Block)new BlockRice(BaseBlockID + 178);
    ...
    MyAppleLeaves = (new BlockAppleLeaves(BaseBlockID + 150)).setHardness(0.2F).setLightOpacity(1).setStepSound(Block.soundTypeGrass).setBlockName("leaves_apple");
    MyAppleSeed = (new ItemAppleSeed(BaseItemID + 211)).setUnlocalizedName("appletree_seed");
    MySkyTreeLog = (new BlockSkyTreeLog(BaseBlockID + 113, 20)).setHardness(0.2F).setStepSound(Block.soundTypeWood).setBlockName("skytreelog");
    MyDT = (new BlockDuplicatorLog(BaseBlockID + 114)).setHardness(0.2F).setStepSound(Block.soundTypeWood).setBlockName("duplicatortreelog");
    MyExperienceLeaves = (new BlockExperienceLeaves(BaseBlockID + 151)).setHardness(0.2F).setLightOpacity(1).setStepSound(Block.soundTypeGrass).setBlockName("leaves_experience");
    ...
    MyFlowerPinkBlock = (new MyBlockFlower(BaseBlockID + 159)).setHardness(0.0F).setStepSound(Block.soundTypeGrass).setBlockName("flower_pink");
    MyFlowerBlueBlock = (new MyBlockFlower(BaseBlockID + 160)).setHardness(0.0F).setStepSound(Block.soundTypeGrass).setBlockName("flower_blue");
    MyFlowerBlackBlock = (new MyBlockFlower(BaseBlockID + 161)).setHardness(0.0F).setStepSound(Block.soundTypeGrass).setBlockName("flower_black");
    MyFlowerScaryBlock = (new MyBlockFlower(BaseBlockID + 162)).setHardness(0.0F).setStepSound(Block.soundTypeGrass).setBlockName("flower_scary");
    MyScaryLeaves = (new BlockScaryLeaves(BaseBlockID + 152)).setHardness(0.2F).setLightOpacity(1).setStepSound(Block.soundTypeGrass).setBlockName("leaves_scary");
    MyCherryLeaves = (new BlockScaryLeaves(BaseBlockID + 176)).setHardness(0.15F).setLightOpacity(1).setStepSound(Block.soundTypeGrass).setBlockName("leaves_cherry");
    MyPeachLeaves = (new BlockScaryLeaves(BaseBlockID + 177)).setHardness(0.15F).setLightOpacity(1).setStepSound(Block.soundTypeGrass).setBlockName("leaves_peach");
    ...
    CrystalFlowerRedBlock = (new MyBlockFlower(BaseBlockID + 203)).setHardness(0.0F).setStepSound(new Block.SoundType("grass", 1.0F, 1.0F)).setBlockName("crystalflower_red");
    CrystalFlowerGreenBlock = (new MyBlockFlower(BaseBlockID + 204)).setHardness(0.0F).setStepSound(new Block.SoundType("grass", 1.0F, 1.0F)).setBlockName("crystalflower_green");
    CrystalFlowerBlueBlock = (new MyBlockFlower(BaseBlockID + 205)).setHardness(0.0F).setStepSound(new Block.SoundType("grass", 1.0F, 1.0F)).setBlockName("crystalflower_blue");
    CrystalFlowerYellowBlock = (new MyBlockFlower(BaseBlockID + 206)).setHardness(0.0F).setStepSound(new Block.SoundType("grass", 1.0F, 1.0F)).setBlockName("crystalflower_yellow");
    MyCrystalLeaves = (new BlockCrystalLeaves(BaseBlockID + 208)).setHardness(0.2F).setLightOpacity(1).setStepSound(new Block.SoundType("grass", 1.0F, 1.0F)).setBlockName("crystaltreeleaves");
    MyCrystalTreeLog = (new BlockCrystalTreeLog(BaseBlockID + 207, 20)).setHardness(0.2F).setStepSound(new Block.SoundType("wood", 1.0F, 1.0F)).setBlockName("crystaltreelog");
    MyCrystalLeaves2 = (new BlockCrystalLeaves(BaseBlockID + 215)).setHardness(0.25F).setLightOpacity(1).setStepSound(new Block.SoundType("grass", 1.0F, 1.0F)).setBlockName("crystaltreeleaves2");
    MyCrystalLeaves3 = (new BlockCrystalLeaves(BaseBlockID + 221)).setHardness(0.25F).setLightOpacity(1).setStepSound(new Block.SoundType("grass", 1.0F, 1.0F)).setBlockName("crystaltreeleaves3");
  ...
  private void make_some_more_things() {
    ...
    GameRegistry.registerBlock((Block)CrystalFurnaceBlock, "OreSpawn_CrystalFurnaceBlock");
    ...
    GameRegistry.registerItem((Item)UltimateHelmet, "OreSpawn_UltimateHelmet");
    GameRegistry.registerItem((Item)UltimateBody, "OreSpawn_UltimateBody");
    GameRegistry.registerItem((Item)UltimateLegs, "OreSpawn_UltimateLegs");
    GameRegistry.registerItem((Item)UltimateBoots, "OreSpawn_UltimateBoots");
    GameRegistry.registerItem((Item)LavaEelHelmet, "OreSpawn_LavaEelHelmet");
    GameRegistry.registerItem((Item)LavaEelBody, "OreSpawn_LavaEelBody");
    GameRegistry.registerItem((Item)LavaEelLegs, "OreSpawn_LavaEelLegs");
    GameRegistry.registerItem((Item)LavaEelBoots, "OreSpawn_LavaEelBoots");
    GameRegistry.registerItem((Item)MothScaleHelmet, "OreSpawn_MothScaleHelmet");
    GameRegistry.registerItem((Item)MothScaleBody, "OreSpawn_MothScaleBody");
    GameRegistry.registerItem((Item)MothScaleLegs, "OreSpawn_MothScaleLegs");
    GameRegistry.registerItem((Item)MothScaleBoots, "OreSpawn_MothScaleBoots");
    ...
    GameRegistry.registerItem((Item)EmeraldHelmet, "OreSpawn_EmeraldHelmet");
    GameRegistry.registerItem((Item)EmeraldBody, "OreSpawn_EmeraldBody");
    GameRegistry.registerItem((Item)EmeraldLegs, "OreSpawn_EmeraldLegs");
    GameRegistry.registerItem((Item)EmeraldBoots, "OreSpawn_EmeraldBoots");
    ...
    GameRegistry.registerItem((Item)ExperienceHelmet, "OreSpawn_ExperienceHelmet");
    GameRegistry.registerItem((Item)ExperienceBody, "OreSpawn_ExperienceBody");
    GameRegistry.registerItem((Item)ExperienceLegs, "OreSpawn_ExperienceLegs");
    GameRegistry.registerItem((Item)ExperienceBoots, "OreSpawn_ExperienceBoots");
    GameRegistry.registerItem((Item)RubyHelmet, "OreSpawn_RubyHelmet");
    GameRegistry.registerItem((Item)RubyBody, "OreSpawn_RubyBody");
    GameRegistry.registerItem((Item)RubyLegs, "OreSpawn_RubyLegs");
    GameRegistry.registerItem((Item)RubyBoots, "OreSpawn_RubyBoots");
    GameRegistry.registerItem((Item)AmethystHelmet, "OreSpawn_AmethystHelmet");
    GameRegistry.registerItem((Item)AmethystBody, "OreSpawn_AmethystBody");
    GameRegistry.registerItem((Item)AmethystLegs, "OreSpawn_AmethystLegs");
    GameRegistry.registerItem((Item)AmethystBoots, "OreSpawn_AmethystBoots");
    ...
    GameRegistry.registerItem((Item)CrystalPinkHelmet, "OreSpawn_CrystalPinkHelmet");
    GameRegistry.registerItem((Item)CrystalPinkBody, "OreSpawn_CrystalPinkBody");
    GameRegistry.registerItem((Item)CrystalPinkLegs, "OreSpawn_CrystalPinkLegs");
    GameRegistry.registerItem((Item)CrystalPinkBoots, "OreSpawn_CrystalPinkBoots");
    GameRegistry.registerItem((Item)TigersEyeHelmet, "OreSpawn_TigersEyeHelmet");
    GameRegistry.registerItem((Item)TigersEyeBody, "OreSpawn_TigersEyeBody");
    GameRegistry.registerItem((Item)TigersEyeLegs, "OreSpawn_TigersEyeLegs");
    GameRegistry.registerItem((Item)TigersEyeBoots, "OreSpawn_TigersEyeBoots");
    GameRegistry.registerItem((Item)PeacockFeatherBoots, "OreSpawn_PeacockFeatherBoots");
    GameRegistry.registerItem((Item)PeacockFeatherHelmet, "OreSpawn_PeacockFeatherHelmet");
    GameRegistry.registerItem((Item)PeacockFeatherBody, "OreSpawn_PeacockFeatherBody");
    GameRegistry.registerItem((Item)PeacockFeatherLegs, "OreSpawn_PeacockFeatherLegs");
    GameRegistry.registerItem((Item)MobzillaHelmet, "OreSpawn_MobzillaHelmet");
    GameRegistry.registerItem((Item)MobzillaBody, "OreSpawn_MobzillaBody");
    GameRegistry.registerItem((Item)MobzillaLegs, "OreSpawn_MobzillaLegs");
    GameRegistry.registerItem((Item)MobzillaBoots, "OreSpawn_MobzillaBoots");
    GameRegistry.registerItem((Item)RoyalHelmet, "OreSpawn_RoyalHelmet");
    GameRegistry.registerItem((Item)RoyalBody, "OreSpawn_RoyalBody");
    GameRegistry.registerItem((Item)RoyalLegs, "OreSpawn_RoyalLegs");
    GameRegistry.registerItem((Item)RoyalBoots, "OreSpawn_RoyalBoots");
    GameRegistry.registerItem((Item)LapisHelmet, "OreSpawn_LapisHelmet");
    GameRegistry.registerItem((Item)LapisBody, "OreSpawn_LapisBody");
    GameRegistry.registerItem((Item)LapisLegs, "OreSpawn_LapisLegs");
    GameRegistry.registerItem((Item)LapisBoots, "OreSpawn_LapisBoots");
    GameRegistry.registerItem((Item)QueenHelmet, "OreSpawn_QueenHelmet");
    GameRegistry.registerItem((Item)QueenBody, "OreSpawn_QueenBody");
    GameRegistry.registerItem((Item)QueenLegs, "OreSpawn_QueenLegs");
    GameRegistry.registerItem((Item)QueenBoots, "OreSpawn_QueenBoots");
    ...
    GameRegistry.addRecipe(new ItemStack((Block)CrystalFurnaceBlock), new Object[] { "FFF", "F F", "FFF", Character.valueOf('F'), CrystalStone });
    GameRegistry.addRecipe(new ItemStack((Block)Blocks.chest), new Object[] { "FFF", "F F", "FFF", Character.valueOf('F'), CrystalPlanksBlock });
    ...
    GameRegistry.addRecipe(new ItemStack(MyUltimateBow), new Object[] { 
          " TS", "I S", " US", Character.valueOf('S'), Items.string, Character.valueOf('I'), Items.iron_ingot, Character.valueOf('U'), MyIngotUranium, Character.valueOf('T'), 
          MyIngotTitanium });
    ...
    GameRegistry.addRecipe(new ItemStack(MyUltimateFishingRod), new Object[] { 
          "  T", " US", "I S", Character.valueOf('S'), Items.string, Character.valueOf('I'), Items.iron_ingot, Character.valueOf('U'), MyIngotUranium, Character.valueOf('T'), 
          MyIngotTitanium });
    GameRegistry.addRecipe(new ItemStack(MyNightmareSword), new Object[] { 
          "ODO", "RTR", "OIO", Character.valueOf('I'), Items.iron_ingot, Character.valueOf('O'), MyNightmareScale, Character.valueOf('D'), Items.diamond, Character.valueOf('R'), 
          Items.redstone, Character.valueOf('T'), MyIngotTitanium });
    ...
    GameRegistry.addRecipe(new ItemStack((Block)Blocks.chest), new Object[] { "EEE", "E E", "EEE", Character.valueOf('E'), CrystalPlanksBlock });
    ...
    EntityRegistry.instance();
    EntityRegistry.registerModEntity(EnchantedCow.class, "Enchanted Golden Apple Cow", EnchantedCowID, this, 64, 1, false);
    EntityRegistry.instance();
    ...
    EntityRegistry.instance();
    EntityRegistry.registerModEntity(Cryolophosaurus.class, "Cryolophosaurus", CryolophosaurusID, this, 64, 1, false);
    EntityRegistry.instance();
    ...
    EntityRegistry.instance();
    EntityRegistry.registerModEntity(EmperorScorpion.class, "Emperor Scorpion", EmperorScorpionID, this, 64, 1, false);
    EntityRegistry.instance();
    ...
    EntityRegistry.instance();
    EntityRegistry.registerModEntity(ThePrinceAdult.class, "The Young Adult Prince", ThePrinceAdultID, this, 128, 1, false);
    EntityRegistry.instance();
    ...
    GameRegistry.addRecipe(new ItemStack((Item)UltimateHelmet), new Object[] { "   ", "TIT", "U U", Character.valueOf('I'), Items.iron_ingot, Character.valueOf('U'), MyIngotUranium, Character.valueOf('T'), MyIngotTitanium });
    GameRegistry.addRecipe(new ItemStack((Item)UltimateHelmet), new Object[] { "TIT", "U U", "   ", Character.valueOf('I'), Items.iron_ingot, Character.valueOf('U'), MyIngotUranium, Character.valueOf('T'), MyIngotTitanium });
    GameRegistry.addRecipe(new ItemStack((Item)UltimateBody), new Object[] { "I I", "TTT", "UUU", Character.valueOf('I'), Items.iron_ingot, Character.valueOf('U'), MyIngotUranium, Character.valueOf('T'), MyIngotTitanium });
    GameRegistry.addRecipe(new ItemStack((Item)UltimateLegs), new Object[] { "III", "T T", "U U", Character.valueOf('I'), Items.iron_ingot, Character.valueOf('U'), MyIngotUranium, Character.valueOf('T'), MyIngotTitanium });
    GameRegistry.addRecipe(new ItemStack((Item)UltimateBoots), new Object[] { "   ", "T T", "U U", Character.valueOf('U'), MyIngotUranium, Character.valueOf('T'), MyIngotTitanium });
    GameRegistry.addRecipe(new ItemStack((Item)UltimateBoots), new Object[] { "T T", "U U", "   ", Character.valueOf('U'), MyIngotUranium, Character.valueOf('T'), MyIngotTitanium });
    ...
    GameRegistry.addRecipe(new ItemStack((Item)LavaEelHelmet), new Object[] { "   ", "***", "* *", Character.valueOf('*'), MyLavaEel });
    GameRegistry.addRecipe(new ItemStack((Item)LavaEelHelmet), new Object[] { "***", "* *", "   ", Character.valueOf('*'), MyLavaEel });
    GameRegistry.addRecipe(new ItemStack((Item)LavaEelBody), new Object[] { "* *", "***", "***", Character.valueOf('*'), MyLavaEel });
    GameRegistry.addRecipe(new ItemStack((Item)LavaEelLegs), new Object[] { "***", "* *", "* *", Character.valueOf('*'), MyLavaEel });
    GameRegistry.addRecipe(new ItemStack((Item)LavaEelBoots), new Object[] { "   ", "* *", "* *", Character.valueOf('*'), MyLavaEel });
    ...
    GameRegistry.addRecipe(new ItemStack((Item)MothScaleHelmet), new Object[] { "   ", "***", "* *", Character.valueOf('*'), MyMothScale });
    GameRegistry.addRecipe(new ItemStack((Item)MothScaleHelmet), new Object[] { "***", "* *", "   ", Character.valueOf('*'), MyMothScale });
    GameRegistry.addRecipe(new ItemStack((Item)MothScaleBody), new Object[] { "* *", "***", "***", Character.valueOf('*'), MyMothScale });
    GameRegistry.addRecipe(new ItemStack((Item)MothScaleLegs), new Object[] { "***", "* *", "* *", Character.valueOf('*'), MyMothScale });
    GameRegistry.addRecipe(new ItemStack((Item)MothScaleBoots), new Object[] { "   ", "* *", "* *", Character.valueOf('*'), MyMothScale });
    ...
    GameRegistry.addRecipe(new ItemStack((Item)EmeraldHelmet), new Object[] { "   ", "***", "* *", Character.valueOf('*'), Items.emerald });
    GameRegistry.addRecipe(new ItemStack((Item)EmeraldHelmet), new Object[] { "***", "* *", "   ", Character.valueOf('*'), Items.emerald });
    GameRegistry.addRecipe(new ItemStack((Item)EmeraldBody), new Object[] { "* *", "***", "***", Character.valueOf('*'), Items.emerald });
    GameRegistry.addRecipe(new ItemStack((Item)EmeraldLegs), new Object[] { "***", "* *", "* *", Character.valueOf('*'), Items.emerald });
    GameRegistry.addRecipe(new ItemStack((Item)EmeraldBoots), new Object[] { "   ", "* *", "* *", Character.valueOf('*'), Items.emerald });
    ...
    GameRegistry.addRecipe(new ItemStack((Item)RubyHelmet), new Object[] { "   ", "***", "* *", Character.valueOf('*'), MyRuby });
    GameRegistry.addRecipe(new ItemStack((Item)RubyHelmet), new Object[] { "***", "* *", "   ", Character.valueOf('*'), MyRuby });
    GameRegistry.addRecipe(new ItemStack((Item)RubyBody), new Object[] { "* *", "***", "***", Character.valueOf('*'), MyRuby });
    GameRegistry.addRecipe(new ItemStack((Item)RubyLegs), new Object[] { "***", "* *", "* *", Character.valueOf('*'), MyRuby });
    GameRegistry.addRecipe(new ItemStack((Item)RubyBoots), new Object[] { "   ", "* *", "* *", Character.valueOf('*'), MyRuby });
    ...
    GameRegistry.addRecipe(new ItemStack((Item)AmethystHelmet), new Object[] { "   ", "***", "* *", Character.valueOf('*'), MyAmethyst });
    GameRegistry.addRecipe(new ItemStack((Item)AmethystHelmet), new Object[] { "***", "* *", "   ", Character.valueOf('*'), MyAmethyst });
    GameRegistry.addRecipe(new ItemStack((Item)AmethystBody), new Object[] { "* *", "***", "***", Character.valueOf('*'), MyAmethyst });
    GameRegistry.addRecipe(new ItemStack((Item)AmethystLegs), new Object[] { "***", "* *", "* *", Character.valueOf('*'), MyAmethyst });
    GameRegistry.addRecipe(new ItemStack((Item)AmethystBoots), new Object[] { "   ", "* *", "* *", Character.valueOf('*'), MyAmethyst });
    ...
    GameRegistry.addRecipe(new ItemStack((Item)CrystalPinkHelmet), new Object[] { "   ", "***", "* *", Character.valueOf('*'), MyCrystalPinkIngot });
    GameRegistry.addRecipe(new ItemStack((Item)CrystalPinkHelmet), new Object[] { "***", "* *", "   ", Character.valueOf('*'), MyCrystalPinkIngot });
    GameRegistry.addRecipe(new ItemStack((Item)CrystalPinkBody), new Object[] { "* *", "***", "***", Character.valueOf('*'), MyCrystalPinkIngot });
    GameRegistry.addRecipe(new ItemStack((Item)CrystalPinkLegs), new Object[] { "***", "* *", "* *", Character.valueOf('*'), MyCrystalPinkIngot });
    GameRegistry.addRecipe(new ItemStack((Item)CrystalPinkBoots), new Object[] { "   ", "* *", "* *", Character.valueOf('*'), MyCrystalPinkIngot });
    ...
    GameRegistry.addRecipe(new ItemStack((Item)MobzillaHelmet), new Object[] { "   ", "***", "* *", Character.valueOf('*'), MyGodzillaScale });
    GameRegistry.addRecipe(new ItemStack((Item)MobzillaHelmet), new Object[] { "***", "* *", "   ", Character.valueOf('*'), MyGodzillaScale });
    GameRegistry.addRecipe(new ItemStack((Item)MobzillaBody), new Object[] { "* *", "***", "***", Character.valueOf('*'), MyGodzillaScale });
    GameRegistry.addRecipe(new ItemStack((Item)MobzillaLegs), new Object[] { "***", "* *", "* *", Character.valueOf('*'), MyGodzillaScale });
    GameRegistry.addRecipe(new ItemStack((Item)MobzillaBoots), new Object[] { "   ", "* *", "* *", Character.valueOf('*'), MyGodzillaScale });
    GameRegistry.addRecipe(new ItemStack((Item)LapisHelmet), new Object[] { "   ", "***", "* *", Character.valueOf('*'), Blocks.lapis_block });
    GameRegistry.addRecipe(new ItemStack((Item)LapisHelmet), new Object[] { "***", "* *", "   ", Character.valueOf('*'), Blocks.lapis_block });
    GameRegistry.addRecipe(new ItemStack((Item)LapisBody), new Object[] { "* *", "***", "***", Character.valueOf('*'), Blocks.lapis_block });
    GameRegistry.addRecipe(new ItemStack((Item)LapisLegs), new Object[] { "***", "* *", "* *", Character.valueOf('*'), Blocks.lapis_block });
    GameRegistry.addRecipe(new ItemStack((Item)LapisBoots), new Object[] { "   ", "* *", "* *", Character.valueOf('*'), Blocks.lapis_block });
    GameRegistry.addRecipe(new ItemStack((Item)QueenHelmet), new Object[] { "   ", "***", "* *", Character.valueOf('*'), MyQueenScale });
    GameRegistry.addRecipe(new ItemStack((Item)QueenHelmet), new Object[] { "***", "* *", "   ", Character.valueOf('*'), MyQueenScale });
    GameRegistry.addRecipe(new ItemStack((Item)QueenBody), new Object[] { "* *", "***", "***", Character.valueOf('*'), MyQueenScale });
    GameRegistry.addRecipe(new ItemStack((Item)QueenLegs), new Object[] { "***", "* *", "* *", Character.valueOf('*'), MyQueenScale });
    GameRegistry.addRecipe(new ItemStack((Item)QueenBoots), new Object[] { "   ", "* *", "* *", Character.valueOf('*'), MyQueenScale });
    ...
    GameRegistry.addRecipe(new ItemStack((Item)PeacockFeatherHelmet), new Object[] { "   ", "***", "* *", Character.valueOf('*'), MyPeacockFeather });
    GameRegistry.addRecipe(new ItemStack((Item)PeacockFeatherHelmet), new Object[] { "***", "* *", "   ", Character.valueOf('*'), MyPeacockFeather });
    GameRegistry.addRecipe(new ItemStack((Item)PeacockFeatherBody), new Object[] { "* *", "***", "***", Character.valueOf('*'), MyPeacockFeather });
    GameRegistry.addRecipe(new ItemStack((Item)PeacockFeatherLegs), new Object[] { "***", "* *", "* *", Character.valueOf('*'), MyPeacockFeather });
    GameRegistry.addRecipe(new ItemStack((Item)PeacockFeatherBoots), new Object[] { "   ", "* *", "* *", Character.valueOf('*'), MyPeacockFeather });
    ...
    GameRegistry.addRecipe(new ItemStack((Item)TigersEyeHelmet), new Object[] { "   ", "***", "* *", Character.valueOf('*'), MyTigersEyeIngot });
    GameRegistry.addRecipe(new ItemStack((Item)TigersEyeHelmet), new Object[] { "***", "* *", "   ", Character.valueOf('*'), MyTigersEyeIngot });
    GameRegistry.addRecipe(new ItemStack((Item)TigersEyeBody), new Object[] { "* *", "***", "***", Character.valueOf('*'), MyTigersEyeIngot });
    GameRegistry.addRecipe(new ItemStack((Item)TigersEyeLegs), new Object[] { "***", "* *", "* *", Character.valueOf('*'), MyTigersEyeIngot });
    GameRegistry.addRecipe(new ItemStack((Item)TigersEyeBoots), new Object[] { "   ", "* *", "* *", Character.valueOf('*'), MyTigersEyeIngot });
    ...
    GameRegistry.addRecipe(new ItemStack((Item)ExperienceHelmet), new Object[] { "EEE", "EAE", "EEE", Character.valueOf('A'), EmeraldHelmet, Character.valueOf('E'), Items.experience_bottle });
    GameRegistry.addRecipe(new ItemStack((Item)ExperienceBody), new Object[] { "EEE", "EAE", "EEE", Character.valueOf('A'), EmeraldBody, Character.valueOf('E'), Items.experience_bottle });
    GameRegistry.addRecipe(new ItemStack((Item)ExperienceLegs), new Object[] { "EEE", "EAE", "EEE", Character.valueOf('A'), EmeraldLegs, Character.valueOf('E'), Items.experience_bottle });
    GameRegistry.addRecipe(new ItemStack((Item)ExperienceBoots), new Object[] { "EEE", "EAE", "EEE", Character.valueOf('A'), EmeraldBoots, Character.valueOf('E'), Items.experience_bottle });
  ...
  public static Entity getPointedAtEntity(World world, EntityPlayer player, double dist) {
    ...
    if (player != null)
      if (world != null) {
        ...
        pointedAt = null;
        float f1 = 1.0F;
        List<Entity> list = world.getEntitiesWithinAABBExcludingEntity((Entity)player, player.boundingBox.addCoord(vec31.xCoord * d0, vec31.yCoord * d0, vec31.zCoord * d0).expand(f1, f1, f1));
        double d2 = d1;
  ...
  private void laySomeEggs() {
    MySpiderSpawnBlock = (OreGenericEgg)(new OreGenericEgg(BaseBlockID + 0)).setBlockName("orespider");
    ...
    MyWitherSkeletonSpawnBlock = (OreGenericEgg)(new OreGenericEgg(BaseBlockID + 22)).setBlockName("orewitherskeleton");
    ...
    MyEmperorScorpionSpawnBlock = (OreGenericEgg)(new OreGenericEgg(BaseBlockID + 39)).setBlockName("oreemperorscorpion");
    ...
    MyCreepingHorrorSpawnBlock = (OreGenericEgg)(new OreGenericEgg(BaseBlockID + 62)).setBlockName("orecreepinghorror");
    MyTerribleTerrorSpawnBlock = (OreGenericEgg)(new OreGenericEgg(BaseBlockID + 63)).setBlockName("oreterribleterror");
    ...
    MyLurkingTerrorSpawnBlock = (OreGenericEgg)(new OreGenericEgg(BaseBlockID + 67)).setBlockName("orelurkingterror");
