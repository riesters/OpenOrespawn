...
public class ThePrinceAdult extends EntityTameable {
  ...
  public void updateAITasks() {
    ...
    if (getActivity() == 0 && this.riddenByEntity == null && this.worldObj.difficultySetting != EnumDifficulty.PEACEFUL && isTamed() && OreSpawnMain.FullPowerKingEnable != 0) {
      this.growcounter++;
  ...
  public void fly_with_rider() {
    ...
    if (this.worldObj.rand.nextInt(5) == 1 && this.worldObj.difficultySetting != EnumDifficulty.PEACEFUL) {
      ...
      if (e != null) {
        setAttacking(1);
        if (getDistanceSqToEntity((Entity)e) < ((10.0F + e.width / 2.0F) * (10.0F + e.width / 2.0F))) {
          attackEntityAsMob((Entity)e);
        } else if (getDistanceSqToEntity((Entity)e) < 625.0D && !isInWater() && 
          getThePrinceAdultFire() != 0) {
      ...
      if (e != null) {
        if (isTamed() && getHealth() / mygetMaxHealth() < 0.25F) {
          ...
          if (getDistanceSqToEntity((Entity)e) < ((10.0F + e.width / 2.0F) * (10.0F + e.width / 2.0F))) {
            ...
            do_new = 1;
          } else if (getDistanceSqToEntity((Entity)e) < 600.0D && !isInWater()) {
            if (getThePrinceAdultFire() != 0 && this.worldObj.rand.nextInt(2) == 1)
              shoot_something(e.posX, e.posY, e.posZ); 
          } 
        } 
      } else {
    ...
    if (this.worldObj.isRemote) {
      ...
      if (getActivity() != 0) {
        ...
        if (this.riddenByEntity != null) {
          ...
          this.motionZ *= 0.985D;
          if (!this.worldObj.isRemote) {
            list = this.worldObj.getEntitiesWithinAABBExcludingEntity((Entity)this, this.boundingBox.expand(6.25D, 10.0D, 6.25D));
  ...
  public boolean interact(EntityPlayer par1EntityPlayer) {
    ...
    if (var2 != null && var2.getItem() == Item.getItemFromBlock(Blocks.diamond_block) && par1EntityPlayer.getDistanceSqToEntity((Entity)this) < 36.0D) {
      if (!this.worldObj.isRemote) {
    ...
    if (isTamed()) {
      if (!func_152114_e((EntityLivingBase)par1EntityPlayer))
        return false; 
      if (var2 == null && par1EntityPlayer.getDistanceSqToEntity((Entity)this) < 36.0D) {
        if (!this.worldObj.isRemote) {
      ...
      if (var2 != null && var2.getItem() == Items.beef && par1EntityPlayer.getDistanceSqToEntity((Entity)this) < 36.0D) {
        if (this.worldObj.isRemote) {
          playTameEffect(true);
      ...
      if (var2 != null && par1EntityPlayer.getDistanceSqToEntity((Entity)this) < 36.0D && var2.getItem() instanceof ItemFood) {
        if (!this.worldObj.isRemote) {
      ...
      if (var2 != null && var2.getItem() == Item.getItemFromBlock(Blocks.ice) && par1EntityPlayer.getDistanceSqToEntity((Entity)this) < 36.0D) {
        if (!this.worldObj.isRemote) {
          playTameEffect(true);
          this.worldObj.setEntityState((Entity)this, (byte)6);
          setThePrinceAdultFire(0);
      ...
      if (var2 != null && var2.getItem() == Items.flint_and_steel && par1EntityPlayer.getDistanceSqToEntity((Entity)this) < 36.0D) {
        if (!this.worldObj.isRemote) {
          playTameEffect(true);
          this.worldObj.setEntityState((Entity)this, (byte)6);
          setThePrinceAdultFire(1);
      ...
      if (var2 != null && var2.getItem() == Items.diamond && par1EntityPlayer.getDistanceSqToEntity((Entity)this) < 36.0D && !this.worldObj.isRemote) {
        Entity ent = null;
      ...
      if (isTamed() && var2 != null && var2.getItem() == Items.name_tag && par1EntityPlayer.getDistanceSqToEntity((Entity)this) < 36.0D && func_152114_e((EntityLivingBase)par1EntityPlayer)) {
  ...
  public void writeEntityToNBT(NBTTagCompound par1NBTTagCompound) {
    ...
    par1NBTTagCompound.setInteger("ThePrinceAdultAttacking", getAttacking());
    par1NBTTagCompound.setInteger("ThePrinceAdultActivity", getActivity());
    par1NBTTagCompound.setInteger("ThePrinceAdultFire", getThePrinceAdultFire());
    par1NBTTagCompound.setInteger("ThePrinceAdultGrow", this.growcounter);
  }
  
  public void readEntityFromNBT(NBTTagCompound par1NBTTagCompound) {
    super.readEntityFromNBT(par1NBTTagCompound);
    setAttacking(par1NBTTagCompound.getInteger("ThePrinceAdultAttacking"));
    setActivity(par1NBTTagCompound.getInteger("ThePrinceAdultActivity"));
    setThePrinceAdultFire(par1NBTTagCompound.getInteger("ThePrinceAdultFire"));
