...
public class ThePrinceAdult extends EntityTameable
{
    ...
    public void fly_with_rider() {
        ...
        if (this.worldObj.rand.nextInt(5) == 1 && this.worldObj.difficultySetting != EnumDifficulty.PEACEFUL) {
            ...
            if (e != null) {
                ...
                else if (this.getDistanceSqToEntity(e) < 625.0 && !this.isInWater() && this.getThePrinceAdultFire() != 0) {
    ...
    private EntityLivingBase findSomethingToAttack() {
        ...
        final List var5 = this.worldObj.getEntitiesWithinAABB(EntityLivingBase.class, this.boundingBox.expand(32.0, 20.0, 32.0));
        ...
        if (toofar == 0 && this.flyaway == 0 && this.worldObj.difficultySetting != EnumDifficulty.PEACEFUL && this.worldObj.rand.nextInt(6) == 1) {
            ...
            if (e != null) {
                if (this.isTamed() && this.getHealth() / this.mygetMaxHealth() < 0.25f) {
                    ...
                    else if (this.getDistanceSqToEntity(e) < 600.0 && !this.isInWater() && this.getThePrinceAdultFire() != 0 && this.worldObj.rand.nextInt(2) == 1) {
                        this.shoot_something(e.posX, e.posY, e.posZ);
                    }
                }
            }
        ...
        if (this.worldObj.isRemote) {
            ...
            if (this.getActivity() != 0) {
                ...
                if (this.riddenByEntity != null) {
                    ...
                    this.motionZ *= 0.985;
                    if (!this.worldObj.isRemote) {
                        list = this.worldObj.getEntitiesWithinAABBExcludingEntity(this, this.boundingBox.expand(6.25, 10.0, 6.25));
    ...
    public boolean interact(final EntityPlayer par1EntityPlayer) {
        ...
        if (var2 != null && var2.getItem() == Item.getItemFromBlock(Blocks.diamond_block) && par1EntityPlayer.getDistanceSqToEntity(this) < 36.0) {
            if (!this.worldObj.isRemote) {
        ...
        if (this.isTamed()) {
            ...
            if (var2 != null && par1EntityPlayer.getDistanceSqToEntity(this) < 36.0 && var2.getItem() instanceof ItemFood) {
                if (!this.worldObj.isRemote) {
            ...
            if (var2 != null && var2.getItem() == Item.getItemFromBlock(Blocks.ice) && par1EntityPlayer.getDistanceSqToEntity(this) < 36.0) {
                if (!this.worldObj.isRemote) {
                    this.playTameEffect(true);
            ...
            if (var2 != null && var2.getItem() == Items.flint_and_steel && par1EntityPlayer.getDistanceSqToEntity(this) < 36.0) {
                if (!this.worldObj.isRemote) {
                    this.playTameEffect(true);
                    this.worldObj.setEntityState(this, (byte)6);
            ...
            if (var2 != null && var2.getItem() == Items.diamond && par1EntityPlayer.getDistanceSqToEntity(this) < 36.0 && !this.worldObj.isRemote) {
                Entity ent;
                ThePrinceTeen d;
            ...
            if (this.isTamed() && var2 != null && var2.getItem() == Items.name_tag && par1EntityPlayer.getDistanceSqToEntity(this) < 36.0 && this.func_152114_e(par1EntityPlayer)) {
