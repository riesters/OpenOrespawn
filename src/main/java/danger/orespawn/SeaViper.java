...
public class SeaViper extends EntityMob {
  ...
  protected void applyEntityAttributes() {
    ...
    getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(OreSpawnMain.SeaViper_stats.attack);
  }
  ...
  protected void dropFewItems(boolean par1, int par2) {
    ItemStack is = null;
    dropItemRand(OreSpawnMain.SeaViperTongue, 1);
    ...
    if (this.worldObj.rand.nextInt(5) == 1) {
      ...
      if (e != null) {
        ...
        if (getDistanceSqToEntity((Entity)e) < ((4.5F + e.width / 2.0F) * (4.5F + e.width / 2.0F))) {
          ...
          getNavigator().tryMoveToEntityLiving((Entity)e, 1.5D);
        } 
      } else {
        setAttacking(0);
      } 
  ...
  public boolean getCanSpawnHere() {
    ...
    if (!this.worldObj.isDaytime())
      return false; 
    target = (SeaViper)this.worldObj.findNearestEntityWithinAABB(SeaViper.class, this.boundingBox.expand(16.0D, 5.0D, 16.0D), (Entity)this);
    if (target != null)
      return false; 
    return true;
  }
