...
public class SeaViper extends EntityMob
{
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(OreSpawnMain.SeaViper_stats.attack);
    }
    ...
    protected void dropFewItems(final boolean par1, final int par2) {
        ItemStack is;
        this.dropItemRand(OreSpawnMain.SeaViperTongue);
        ...
        if (this.worldObj.rand.nextInt(5) == 1) {
            ...
            if (e != null) {
                ...
                if (this.getDistanceSqToEntity(e) < (4.5f + e.width / 2.0f) * (4.5f + e.width / 2.0f)) {
                    ...
                    this.getNavigator().tryMoveToEntityLiving(e, 1.5);
                }
            }
            else {
                this.setAttacking(0);
    ...
    private EntityLivingBase findSomethingToAttack() {
        ...
        final List var5 = this.worldObj.getEntitiesWithinAABB(EntityLivingBase.class, this.boundingBox.expand(18.0, 4.0, 18.0));
    ...
    public boolean getCanSpawnHere() {
        ...
        target = (SeaViper)this.worldObj.findNearestEntityWithinAABB(SeaViper.class, this.boundingBox.expand(16.0, 5.0, 16.0), this);
        return target == null;
    }
