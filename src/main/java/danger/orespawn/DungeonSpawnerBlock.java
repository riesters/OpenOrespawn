...
public class DungeonSpawnerBlock extends BlockReed {
  ...
  public void randomDisplayTick(World par1World, int par2, int par3, int par4, Random par5Random) {
    for (int j1 = 0; j1 < 5; j1++)
      par1World.spawnParticle("fireworksSpark", (par2 + par1World.rand.nextFloat()), par3 + par1World.rand.nextFloat(), (par4 + par1World.rand.nextFloat()), (par1World.rand.nextFloat() - par1World.rand.nextFloat()) / 4.0D, par1World.rand.nextFloat() / 2.0D, (par1World.rand.nextFloat() - par1World.rand.nextFloat()) / 4.0D); 
  }
