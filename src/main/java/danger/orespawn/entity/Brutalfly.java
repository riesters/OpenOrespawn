...
public class Brutalfly extends EntityMob
{
    ...
    private boolean canSeeTarget(final double pX, final double pY, final double pZ) {
    ...
    protected void updateAITasks() {
        ...
        if (this.stuck_count > 30 || this.world.rand.nextInt(200) == 0 || this.currentFlightTarget.distanceSq((double)(int)this.posX, (double)(int)this.posY, (double)(int)this.posZ) < 9.0) {
            int down = 0;
            int dist = 20;
            for (int i = -5; i <= 5; i += 5) {
                for (int j = -5; j <= 5; j += 5) {
        ...
        if (this.world.rand.nextInt(6) == 0) {
            ...
            target = (EntityPlayer)this.world.findNearestEntityWithinAABB((Class)EntityPlayer.class, this.getEntityBoundingBox().expand(30.0, 20.0, 30.0), (Entity)this);
            if (target != null) {
    ...
    public boolean getCanSpawnHere() {
        ...
        target = (Brutalfly)this.world.findNearestEntityWithinAABB((Class)Brutalfly.class, this.getEntityBoundingBox().expand(64.0, 32.0, 64.0), (Entity)this);
        return target == null;
    }
    ...
    protected void dropFewItems(final boolean par1, final int par2) {
        ...
        for (int var4 = 0; var4 < 20; ++var4) {
            spawnCreature(this.world, "Butterfly", this.posX + 0.5, this.posY + 1.0, this.posZ + 0.5);
        }
    }
    ...
    private EntityLivingBase findSomethingToAttack() {
        final List var5 = this.world.getEntitiesWithinAABB((Class)EntityLivingBase.class, this.getEntityBoundingBox().expand(25.0, 20.0, 25.0));
