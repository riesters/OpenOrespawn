...
public class TheKing extends EntityMob {
  ...
  protected void dropFewItems(boolean par1, int par2) {
    ...
    dropItemRand((Item)OreSpawnMain.RoyalBody, 1);
    dropItemRand((Item)OreSpawnMain.RoyalHelmet, 1);
    dropItemRand((Item)OreSpawnMain.RoyalLegs, 1);
    dropItemRand((Item)OreSpawnMain.RoyalBoots, 1);
    ...
    for (j = 0; j < 150; ) {
      ...
      if (bl != null) {
        j++;
        dropItemRand(Item.getItemFromBlock(bl), 1);
      } 
    } 
  }
  ...
  public void onUpdate() {
    ...
    if (this.player_hit_count < 10 && getHealth() < (mygetMaxHealth() / 8))
  ...
  private void msgToPlayers(String s) {
    ...
    while (var2.hasNext()) {
      ...
      var4.addChatComponentMessage((IChatComponent)new ChatComponentText(s));
    } 
  }
  ...
  protected void updateAITasks() {
    ...
    if (this.isEnd == 1) {
      ...
      p = findNearestPlayer();
      if (p != null) {
        faceEntity((Entity)p, 10.0F, 10.0F);
        p.motionX = 0.0D;
        p.motionY = 0.0D;
        p.motionZ = 0.0D;
      ...
      if (e != null) {
        ...
        if (getDistanceSqToEntity((Entity)e) < 900.0D) {
          if (this.worldObj.rand.nextInt(2) == 1)
            doJumpDamage(this.posX, this.posY, this.posZ, 15.0D, (OreSpawnMain.TheKing_stats.attack / 4), 0); 
        ...
        if (this.worldObj.rand.nextInt(3) == 1)
          doJumpDamage(dx, this.posY + 10.0D, dz, 15.0D, (OreSpawnMain.TheKing_stats.attack / 2), 1); 
