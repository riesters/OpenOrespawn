...
public class GirlfriendOverlayGui extends Gui {
  ...
  public void onRenderOverlay(RenderGameOverlayEvent event) {
    ...
    if (entity instanceof Girlfriend) {
      ...
      if (!gf.func_152114_e((EntityLivingBase)entityClientPlayerMP))
        return; 
      if (gf.passenger != 0)
        return; 
    ...
    int y = 25;
    if (entityClientPlayerMP.isInsideOfMaterial(Material.water) || entityClientPlayerMP.getTotalArmorValue() > 0)
      y -= 10; 
