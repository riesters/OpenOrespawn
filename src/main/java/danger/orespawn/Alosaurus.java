...
public class Alosaurus extends EntityMob {
  ...
  protected void applyEntityAttributes() {
    ...
    getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(OreSpawnMain.Alosaurus_stats.attack);
  }
  ...
  public boolean getCanSpawnHere() {
    ...
    target = (Alosaurus)this.worldObj.findNearestEntityWithinAABB(Alosaurus.class, this.boundingBox.expand(16.0D, 8.0D, 16.0D), (Entity)this);
    if (target != null)
      return false; 
    return true;
  }
