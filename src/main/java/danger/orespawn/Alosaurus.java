...
public class Alosaurus extends EntityMob
{
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(OreSpawnMain.Alosaurus_stats.attack);
    }
    ...
    private EntityLivingBase findSomethingToAttack() {
        ...
        final List var5 = this.worldObj.getEntitiesWithinAABB(EntityLivingBase.class, this.boundingBox.expand(12.0, 5.0, 12.0));
    ...
    public boolean getCanSpawnHere() {
        ...
        Alosaurus target;
        target = (Alosaurus)this.worldObj.findNearestEntityWithinAABB(Alosaurus.class, this.boundingBox.expand(16.0, 8.0, 16.0), this);
        return target == null;
    }
}
