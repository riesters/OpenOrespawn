  ...
  public void onArmorTick(World world, EntityPlayer player, ItemStack itemStack) {
    ...
    if (this.armor_material == 11 || this.armor_material == 9)
      if (player != null) {
        ...
        if (boots != null && ((
          boots.getItem() == OreSpawnMain.RoyalBoots && OreSpawnMain.RoyalGlideEnable != 0) || boots.getItem() == OreSpawnMain.PeacockFeatherBoots)) {
          if (player.motionY < -0.10000000149011612D)
    ...
    if (this.armor_material == 13)
      if (player != null) {
        boots = player.getEquipmentInSlot(1);
        if (boots != null && 
          boots.getItem() == OreSpawnMain.QueenBoots && OreSpawnMain.RoyalGlideEnable != 0) {
