...
public class ChunkProviderOreSpawn3 implements IChunkProvider
{
    ...
    public void populate(final IChunkProvider par1IChunkProvider, final int par2, final int par3) {
        ...
        if (biomegenbase != BiomeGenBase.desert && biomegenbase != BiomeGenBase.desertHills && !flag && this.rand.nextInt(4) == 0 && TerrainGen.populate(par1IChunkProvider, this.worldObj, this.rand, par2, par3, false, PopulateChunkEvent.Populate.EventType.LAKE)) {
        ...
        for (doGen = TerrainGen.populate(par1IChunkProvider, this.worldObj, this.rand, par2, par3, flag, PopulateChunkEvent.Populate.EventType.ICE), k2 = 0; doGen && k2 < 16; ++k2) {
            for (int ww = 0; ww < 16; ++ww) {
                i2 = this.worldObj.getPrecipitationHeight(k + k2, l + ww);
                if (this.worldObj.isBlockFreezable(k2 + k, i2 - 1, ww + l)) {
                    this.worldObj.setBlock(k2 + k, i2 - 1, ww + l, Blocks.ice, 0, 2);
                }
                if (this.worldObj.func_147478_e(k2 + k, i2, ww + l, true)) {
                    this.worldObj.setBlock(k2 + k, i2, ww + l, Blocks.snow_layer, 0, 2);
                }
            }
        }
