...
public class TRex extends EntityMob
{
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(OreSpawnMain.TRex_stats.attack);
    }
    ...
    protected void dropFewItems(final boolean par1, final int par2) {
        this.dropItemRand(OreSpawnMain.TRexTooth);
    ...
    public boolean getCanSpawnHere() {
        ...
        TRex target;
        target = (TRex)this.worldObj.findNearestEntityWithinAABB(TRex.class, this.boundingBox.expand(24.0, 12.0, 24.0), this);
        return target == null;
    }
}
