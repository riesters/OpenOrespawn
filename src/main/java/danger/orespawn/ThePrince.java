...
public class ThePrince extends EntityTameable {
  ...
  public boolean interact(EntityPlayer par1EntityPlayer) {
    ...
    if (var2 != null && var2.getItem() == Items.diamond && par1EntityPlayer.getDistanceSqToEntity((Entity)this) < 16.0D && func_152114_e((EntityLivingBase)par1EntityPlayer) && !this.worldObj.isRemote && this.ok_to_grow != 0) {
      Entity ent = null;
