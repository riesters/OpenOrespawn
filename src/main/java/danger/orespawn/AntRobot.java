...
public class AntRobot extends EntityLiving {
  ...
  public AntRobot(World par1World) {
    ...
    this.tasks.addTask(1, (EntityAIBase)new EntityAIWatchClosest(this, EntityPlayer.class, 12.0F));
    this.tasks.addTask(2, (EntityAIBase)new EntityAILookIdle(this));
  ...
  protected void applyEntityAttributes() {
    ...
    getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(OreSpawnMain.AntRobot_stats.health);
    getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(this.moveSpeed);
    getAttributeMap().registerAttribute(SharedMonsterAttributes.attackDamage);
    getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(OreSpawnMain.AntRobot_stats.attack);
  }
  ...
  public void onUpdate() {
    ...
    if (this.worldObj.difficultySetting != EnumDifficulty.PEACEFUL && !this.worldObj.isRemote && this.riddenByEntity != null && this.worldObj.rand.nextInt(9) == 0) {
      EntityLivingBase e = null;
      e = findSomethingToAttack(1.0F, true);
      if (e != null) {
        if (getDistanceSqToEntity((Entity)e) < ((6.0F + e.width / 2.0F) * (6.0F + e.width / 2.0F))) {
          setAttacking(1);
          attackEntityAsMob((Entity)e);
    ...
    if (this.worldObj.rand.nextInt(18) == 0)
      this.worldObj.spawnParticle("flame", this.posX + dx, this.posY + 0.5D, this.posZ + dz, (dx2 / f + (this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) / 20.0F), ((this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) / 10.0F), (dz2 / f + (this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) / 20.0F)); 
    if (this.worldObj.rand.nextInt(7) == 0)
      this.worldObj.spawnParticle("smoke", this.posX + dx, this.posY + 0.5D, this.posZ + dz, (dx2 / f + (this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) / 20.0F), ((this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) / 10.0F), (dz2 / f + (this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) / 20.0F)); 
    if (this.worldObj.rand.nextInt(16) == 0)
      this.worldObj.spawnParticle("fireworksSpark", this.posX + dx, this.posY + 0.5D, this.posZ + dz, (dx2 / f + (this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) / 20.0F), ((this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) / 5.0F), (dz2 / f + (this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) / 20.0F)); 
  ...
  private EntityLivingBase findSomethingToAttack(float distmul, boolean dircheck) {
    if (OreSpawnMain.PlayNicely != 0)
      return null; 
    List var5 = this.worldObj.getEntitiesWithinAABB(EntityLivingBase.class, this.boundingBox.expand(12.0D * distmul, 12.0D, 12.0D * distmul));
    Iterator<Entity> var2 = var5.iterator();
    Entity var3 = null;
    EntityLivingBase var4 = null;
    while (var2.hasNext()) {
      var3 = var2.next();
      var4 = (EntityLivingBase)var3;
      if (isSuitableTarget(var4, dircheck))
        return var4; 
    } 
    return null;
  }
  ...
  public boolean attackEntityAsMob(Entity par1Entity) {
    ...
    if (par1Entity != null && par1Entity instanceof EntityLivingBase) {
      ...
      double inair = 0.1D;
      float f3 = (float)Math.atan2(par1Entity.posZ - this.posZ, par1Entity.posX - this.posX);
      ret = par1Entity.attackEntityFrom(DamageSource.causeMobDamage((EntityLivingBase)this), OreSpawnMain.AntRobot_stats.attack);
      if (par1Entity.isDead || par1Entity instanceof EntityPlayer)
        inair *= 2.0D; 
      if (ret)
        par1Entity.addVelocity(Math.cos(f3) * ks, inair, Math.sin(f3) * ks); 
