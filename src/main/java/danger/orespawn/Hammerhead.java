...
public class Hammerhead extends EntityMob {
  ...
  protected void applyEntityAttributes() {
    ...
    getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(OreSpawnMain.Hammerhead_stats.attack);
  }
  ...
  private void dropItemRand(Item index, int par1) {
    EntityItem var3 = new EntityItem(this.worldObj, this.posX + OreSpawnMain.OreSpawnRand.nextInt(5) - OreSpawnMain.OreSpawnRand.nextInt(5), this.posY + 2.0D, this.posZ + OreSpawnMain.OreSpawnRand.nextInt(5) - OreSpawnMain.OreSpawnRand.nextInt(5), new ItemStack(index, par1, 0));
  ...
  protected void dropFewItems(boolean par1, int par2) {
    ...
    for (var4 = 0; var4 < 8; var4++)
      dropItemRand(Items.experience_bottle, 1); 
    for (var4 = 0; var4 < 10; var4++)
      dropItemRand(OreSpawnMain.MyExperienceCatcher, 1); 
    for (var4 = 0; var4 < 16; var4++)
      dropItemRand(OreSpawnMain.CreeperLauncher, 1); 
    for (var4 = 0; var4 < 4; var4++)
      dropItemRand(Item.getItemFromBlock(OreSpawnMain.CreeperRepellent), 1); 
    for (var4 = 0; var4 < 6; var4++)
      dropItemRand(Items.beef, 1); 
    for (var4 = 0; var4 < 2; var4++)
      dropItemRand(OreSpawnMain.MyExperienceTreeSeed, 1); 
    if (this.worldObj.rand.nextInt(3) == 1)
      dropItemRand(OreSpawnMain.MyHammy, 1); 
  }
  ...
  public boolean getCanSpawnHere() {
    ...
    target = (Hammerhead)this.worldObj.findNearestEntityWithinAABB(Hammerhead.class, this.boundingBox.expand(16.0D, 8.0D, 16.0D), (Entity)this);
    if (target != null)
      return false; 
    return true;
  }
