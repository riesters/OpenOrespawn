...
public class QueenHead extends EntityLiving {
  ...
  protected void applyEntityAttributes() {
    ...
    getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(OreSpawnMain.TheQueen_stats.health);
  ...
  public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
    ...
    if (e != null && (e instanceof TheQueen || e instanceof QueenHead))
      return false; 
    List var5 = this.worldObj.getEntitiesWithinAABB(TheQueen.class, this.boundingBox.expand(48.0D, 32.0D, 48.0D));
  ...
  public void onUpdate() {
    ...
    if (this.worldObj.isRemote) {
      ...
      if (var2.hasNext()) {
        ...
        this.posX = var4.posX - 30.0D * Math.sin(Math.toRadians(var4.rotationYawHead));
        this.posZ = var4.posZ + 30.0D * Math.cos(Math.toRadians(var4.rotationYawHead));
