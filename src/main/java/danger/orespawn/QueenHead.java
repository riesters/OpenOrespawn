...
public class QueenHead extends EntityLiving
{
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(OreSpawnMain.TheQueen_stats.health);
    ...
    public boolean attackEntityFrom(final DamageSource par1DamageSource, final float par2) {
        ...
        final List var5 = this.worldObj.getEntitiesWithinAABB(TheQueen.class, this.boundingBox.expand(48.0, 32.0, 48.0));
    ...
    public void onUpdate() {
        ...
        if (this.worldObj.isRemote) {
            ...
            final List var5 = this.worldObj.getEntitiesWithinAABB(TheQueen.class, this.boundingBox.expand(32.0, 32.0, 32.0));
            final Iterator var6 = var5.iterator();
            Entity var7;
            TheQueen var8;
            if (var6.hasNext()) {
