...
public class EasterBunny extends EntityAnimal {
  ...
  public EasterBunny(World par1World) {
    ...
    this.tasks.addTask(6, new MyEntityAIWanderALot((EntityCreature)this, 16, 1.0D));
  ...
  public boolean getCanSpawnHere() {
    ...
    target = (EasterBunny)this.worldObj.findNearestEntityWithinAABB(EasterBunny.class, this.boundingBox.expand(32.0D, 8.0D, 32.0D), (Entity)this);
    if (target != null)
      return false; 
    return true;
  }
  ...
  protected void updateAITick() {
    ...
    if (this.worldObj.rand.nextInt(600) == 1)
      LayAnEgg(1 + this.worldObj.rand.nextInt(3)); 
  }
