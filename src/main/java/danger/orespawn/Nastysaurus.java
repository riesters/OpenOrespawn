...
public class Nastysaurus extends EntityMob {
  ...
  protected void applyEntityAttributes() {
    ...
    getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(OreSpawnMain.Nastysaurus_stats.attack);
  }
  ...
  private void dropItemRand(Item index, int par1) {
    EntityItem var3 = new EntityItem(this.worldObj, this.posX + OreSpawnMain.OreSpawnRand.nextInt(4) - OreSpawnMain.OreSpawnRand.nextInt(4), this.posY + 3.0D, this.posZ + OreSpawnMain.OreSpawnRand.nextInt(4) - OreSpawnMain.OreSpawnRand.nextInt(4), new ItemStack(index, par1, 0));
  ...
  protected void updateAITasks() {
    ...
    if (this.worldObj.rand.nextInt(5) == 0) {
      ...
      if (e != null) {
        ...
        if (getDistanceSqToEntity((Entity)e) < ((4.5F + e.width / 2.0F) * (4.5F + e.width / 2.0F))) {
          setAttacking(1);
  ...
  public boolean getCanSpawnHere() {
    ...
    target = (Nastysaurus)this.worldObj.findNearestEntityWithinAABB(Nastysaurus.class, this.boundingBox.expand(16.0D, 8.0D, 16.0D), (Entity)this);
    if (target != null)
      return false; 
    return true;
  }
