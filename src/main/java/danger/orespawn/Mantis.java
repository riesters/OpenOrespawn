...
public class Mantis extends EntityMob {
  ...
  protected void applyEntityAttributes() {
    ...
    getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(OreSpawnMain.Mantis_stats.attack);
  }
  ...
  private void dropItemRand(Item index, int par1) {
    EntityItem var3 = new EntityItem(this.worldObj, this.posX + OreSpawnMain.OreSpawnRand.nextInt(5) - OreSpawnMain.OreSpawnRand.nextInt(5), this.posY + 1.0D, this.posZ + OreSpawnMain.OreSpawnRand.nextInt(5) - OreSpawnMain.OreSpawnRand.nextInt(5), new ItemStack(index, par1, 0));
    this.worldObj.spawnEntityInWorld((Entity)var3);
  }
  
  protected void dropFewItems(boolean par1, int par2) {
    dropItemRand(OreSpawnMain.MyMantisClaw, 1);
    dropItemRand(OreSpawnMain.MyMantisClaw, 1);
  ...
  public void onUpdate() {
    super.onUpdate();
    this.motionY *= 0.6D;
    if (isInWater() && this.worldObj.rand.nextInt(20) == 1)
  ...
  public boolean getCanSpawnHere() {
    ...
    if (!this.worldObj.isDaytime())
      return false; 
    Mantis target = null;
    target = (Mantis)this.worldObj.findNearestEntityWithinAABB(Mantis.class, this.boundingBox.expand(32.0D, 16.0D, 32.0D), (Entity)this);
    if (target != null)
      return false; 
    return true;
  }
