...
public class KingHead extends EntityLiving {
  ...
  protected void applyEntityAttributes() {
    ...
    getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(OreSpawnMain.TheKing_stats.health);
  ...
  public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
    ...
    if (e != null && (e instanceof TheKing || e instanceof KingHead))
      return false; 
    List var5 = this.worldObj.getEntitiesWithinAABB(TheKing.class, this.boundingBox.expand(48.0D, 32.0D, 48.0D));
