...
public class EnderReaper extends EntityMob {
  ...
  protected void applyEntityAttributes() {
    ...
    getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(OreSpawnMain.EnderReaper_stats.health);
    getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(0.37D);
    getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(OreSpawnMain.EnderReaper_stats.attack);
  }
  ...
  protected Entity findPlayerToAttack() {
    if (OreSpawnMain.PlayNicely != 0)
      return null; 
    EntityPlayer entityplayer = this.worldObj.getClosestVulnerablePlayerToEntity((Entity)this, 81.0D);
  ...
  public boolean getCanSpawnHere() {
    ...
    target = (EnderReaper)this.worldObj.findNearestEntityWithinAABB(EnderReaper.class, this.boundingBox.expand(16.0D, 8.0D, 16.0D), (Entity)this);
    if (target != null)
      return false; 
    return true;
  }
