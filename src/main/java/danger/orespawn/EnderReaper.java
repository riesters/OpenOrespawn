...
public class EnderReaper extends EntityMob
{
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(OreSpawnMain.EnderReaper_stats.health);
        this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(0.37);
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(OreSpawnMain.EnderReaper_stats.attack);
    }
    ...
    public boolean getCanSpawnHere() {
        ...
        EnderReaper target;
        target = (EnderReaper)this.worldObj.findNearestEntityWithinAABB(EnderReaper.class, this.boundingBox.expand(16.0, 8.0, 16.0), this);
        return target == null;
    }
