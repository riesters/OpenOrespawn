...
public class CritterCage extends Item {
  ...
  public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10) {
    ...
    for (int var3 = 0; var3 < 6; var3++) {
      par2EntityPlayer.worldObj.spawnParticle("smoke", (par4 + 0.5F), (par5 + 1.25F), (par6 + 0.5F), 0.0D, 0.0D, 0.0D);
      par2EntityPlayer.worldObj.spawnParticle("explode", (par4 + 0.5F), (par5 + 1.25F), (par6 + 0.5F), 0.0D, 0.0D, 0.0D);
      par2EntityPlayer.worldObj.spawnParticle("reddust", (par4 + 0.5F), (par5 + 1.25F), (par6 + 0.5F), 0.0D, 0.0D, 0.0D);
    } 
    ...
    if (entityID != 0 || name != null) {
      Entity ent = null;
      ent = spawnCreature(par3World, entityID, name, par4 + 0.5D, par5 + 1.1D, par6 + 0.5D);
      if (ent != null) {
