...
public class Brutalfly extends EntityMob
{
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(OreSpawnMain.Brutalfly_stats.attack);
    }
    ...
    protected void updateAITasks() {
        ...
        if (this.worldObj.rand.nextInt(6) == 0) {
            EntityPlayer target;
            target = (EntityPlayer)this.worldObj.findNearestEntityWithinAABB(EntityPlayer.class, this.boundingBox.expand(30.0, 20.0, 30.0), this);
            if (target != null) {
    ...
    public boolean getCanSpawnHere() {
        ...
        Brutalfly target;
        target = (Brutalfly)this.worldObj.findNearestEntityWithinAABB(Brutalfly.class, this.boundingBox.expand(64.0, 32.0, 64.0), this);
        return target == null;
    }
    ...
    private void dropItemRand() {
        final EntityItem var3 = new EntityItem(this.worldObj, this.posX + OreSpawnMain.OreSpawnRand.nextInt(8) - OreSpawnMain.OreSpawnRand.nextInt(8), this.posY + 1.0, this.posZ + OreSpawnMain.OreSpawnRand.nextInt(8) - OreSpawnMain.OreSpawnRand.nextInt(8), new ItemStack(Items.gold_nugget, 1, 0));
