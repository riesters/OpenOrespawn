...
public class Brutalfly extends EntityMob {
  ...
  protected void applyEntityAttributes() {
    ...
    getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(OreSpawnMain.Brutalfly_stats.attack);
  }
  ...
  protected void updateAITasks() {
    ...
    if (this.worldObj.rand.nextInt(6) == 0) {
      ...
      target = (EntityPlayer)this.worldObj.findNearestEntityWithinAABB(EntityPlayer.class, this.boundingBox.expand(30.0D, 20.0D, 30.0D), (Entity)this);
      if (target != null)
  ...
  public boolean getCanSpawnHere() {
    ...
    target = (Brutalfly)this.worldObj.findNearestEntityWithinAABB(Brutalfly.class, this.boundingBox.expand(64.0D, 32.0D, 64.0D), (Entity)this);
    if (target != null)
      return false; 
    return true;
  }
