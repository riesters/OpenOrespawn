...
public class UltimateArrow extends EntityArrow {
  ...
  public void onUpdate() {
    ...
    if (this.inGround) {
      ...
      Entity var5 = null;
      List<Entity> var6 = this.worldObj.getEntitiesWithinAABBExcludingEntity((Entity)this, this.boundingBox.addCoord(this.motionX, this.motionY, this.motionZ).expand(1.0D, 1.0D, 1.0D));
      double var7 = 0.0D;
      int var9;
      for (var9 = 0; var9 < var6.size(); var9++) {
        ...
        if (var10.canBeCollidedWith() && (var10 != this.shootingEntity || this.ticksInAir >= 5) && !(var10 instanceof Elevator)) {
          ...
          float f = 0.3F;
          AxisAlignedBB var12 = var10.boundingBox.expand(f, f, f);
      ...
      if (var4 != null)
        if (var4.entityHit != null) {
          ...
          float var23 = MathHelper.ceiling_double_int(f1 * OreSpawnMain.UltimateBowDamage);
          ...
          if (this.shootingEntity == null) {
            var21 = DamageSource.causeArrowDamage(this, (Entity)this);
          } else {
          ...
          this.posX -= this.motionX / f * 0.05D;
          this.posY -= this.motionY / f * 0.05D;
          this.posZ -= this.motionZ / f * 0.05D;
          playSound("random.bowhit", 1.0F, 1.2F / (this.rand.nextFloat() * 0.2F + 0.9F));
          this.inGround = true;
          this.arrowShake = 7;
          setIsCritical(false);
