...
public class GiantRobot extends EntityMob
{
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(OreSpawnMain.Jeffery_stats.attack);
    }
    ...
    protected void dropFewItems(final boolean par1, final int par2) {
        ...
        for (int i = 10 + this.worldObj.rand.nextInt(10), var6 = 0; var6 < i; ++var6) {
            ...
            switch (var7) {
                case 0: {
                    this.dropItemRand(OreSpawnMain.SpiderRobotKit, 1);
                    break;
                }
                case 1: {
                    this.dropItemRand(OreSpawnMain.AntRobotKit, 1);
                    break;
                }
                case 2: {
                ...
                case 9: {
                    this.dropItemRand(Item.getItemFromBlock(Blocks.detector_rail), 1);
                    break;
                }
            }
        }
